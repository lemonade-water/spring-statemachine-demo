...
@Service
public class AcceptedAction implements OrderAction {
    @Resource
    ...
    public void execute(StateContext<OrderStatusEnum, OrderEventEnum> context) {
        ...
        order.setStatus(OrderStatusEnum.TO_BE_FINISHED.getCode());
        OrderEvent event = new OrderEvent(order.getId(), OrderEventEnum.ACCEPTED);
